...
{
    static readonly DEFULT_WIKI_SUMMARY = '* Summary of business use case here. Can take from spec.';
    static readonly DEFULT_WIKI_SPECIFICATION_LINK = '* JIRA numbers / links here.\n* Document links.';
